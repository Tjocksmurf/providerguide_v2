...
/**
 * extractfromends a value from an array.
 *
 * The extractfromend process plugin is used to pull data from an input array, which
 * may have multiple levels. One use case is extractfromending data from field arrays
 ...
 * )
 */
class ExtractFromEnd extends ProcessPluginBase {
  ...
  public function transform($value, MigrateExecutableInterface $migrate_executable, Row $row, $destination_property) {
    ...
    if (!$key_exists) {
      if (array_key_exists('default', $this->configuration)) {
        ...
        throw new MigrateException('Array index missing, extractfromendion failed.');
      }
    }
    return $new_value;
  }
